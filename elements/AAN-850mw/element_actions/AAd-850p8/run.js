function(instance, properties, context) {
    ...
    // Usar pdf-lib para carregar e re-salvar o PDF com compressão avançada:
    // As opções "compress: true" e "useObjectStreams: true" podem reduzir o tamanho do arquivo.
    PDFLib.PDFDocument.load(byteArray)
      .then(pdfDoc => {
          // (Opcional) Você pode remover metadados ou limpar informações desnecessárias aqui.
          return pdfDoc.save({ compress: true, useObjectStreams: true });
      })
      .then(newPdfBytes => {
